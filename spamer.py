...
def basalam(phone):
    ...
    "query": "mutation verificationequest($mobile: MobileScalar!) { mobileVerificationequest(mobile: $mobile) { success } }"
}
...
''')
    ...
    try:
        ...
        webbrowser.open('https://github.com/z0roday/spam')
        system('clear')
    while True:
        try: Vip(phone, Time)
